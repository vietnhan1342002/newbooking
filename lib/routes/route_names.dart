...
import 'package:flutter_hotel_booking_ui/modules/info_booking/info_booking_screen.dart';
...
class NavigationServices {
  ...
  Future<dynamic> gotoInfoBookingScreen(String hotelname) async {
    return await _pushMaterialPageRoute(
        InfoBookingScreen(hotelName: hotelname));
  }
